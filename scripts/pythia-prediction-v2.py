"""
Pythia — sequential pipeline using pythia_library_v2.

Identical logic to scripts/pythia-prediction-v1.py but using the v2 library.
Run this to establish a fair timing baseline before comparing against
scripts/pythia-prediction-v2-optimized.py (both use pythia_library_v2).
"""
import argparse
import pandas as pd
...
def main():
    ...
    parser.add_argument(
        "--output", default="results-v2.csv",
        metavar="FILE", help="Output CSV path (default: results-v2.csv)",
    )
